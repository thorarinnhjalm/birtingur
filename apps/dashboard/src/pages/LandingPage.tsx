        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => changeTab('home')}>
            ...
            <div>
              ...
              <span className="hidden sm:inline text-xs font-semibold px-2 py-0.5 ml-2 rounded-full bg-blue-50 text-blue-600 border border-blue-200/60">Birta.is</span>
            </div>
          </div>
      ...
      <main className="grow">
          ...
          <div className="space-y-16 sm:space-y-24 md:space-y-32 pb-24">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                ...
                <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
                  ...
                  <p className="text-base sm:text-lg lg:text-xl text-slate-500 max-w-xl font-medium leading-relaxed">
                    Ada (birta.is) er nútímalegur sjálfsafgreiðsluvettvangur sem tengir saman íslenska útgefendur og auglýsendur. Stofnaðu herferðir á nokkrum mínútum eða byrjaðu að græða á vefnum þínum í dag.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                    ...
                    >
                      Ég vil auglýsa (Kaupandi) <span className="material-symbols-outlined">campaign</span>
                    </button>
                    <button 
                      onClick={() => changeTab('publishers')}
                    ...
                    >
                      Ég vil birta auglýsingar (Söluaðili) <span className="material-symbols-outlined text-lg">add_to_queue</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="lg:col-span-5 relative w-full flex justify-center">
                  <div className="relative w-full max-w-md p-6 rounded-3xl bg-white border border-slate-200/80 shadow-xl shadow-slate-100/50 overflow-hidden">
                    ...
                    <div className="flex items-center justify-between pb-4 border-b border-slate-150 mb-5">
                      ...
                      <span className="text-xs font-semibold text-slate-400">Mínar herferðir (Mockup)</span>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 rounded-2xl bg-slate-50 border border-slate-150 flex items-center justify-between">
                        <div>
                          <span className="text-xs text-slate-500 font-semibold block mb-0.5">Sýningar samtals</span>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-150">
                          <span className="text-xs text-slate-500 font-semibold block mb-1">Smellihlutfall</span>
                          <span className="text-lg font-extrabold text-green-600">1.82%</span>
                          <span className="text-[10px] text-green-600 font-semibold block mt-0.5">↑ 0.4% vs. í gær</span>
                        </div>
                        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-150">
                          <span className="text-xs text-slate-500 font-semibold block mb-1">Eftirstöðvar</span>
                          <span className="text-lg font-extrabold text-blue-600">42.500 kr.</span>
                          <span className="text-[10px] text-slate-500 font-semibold block mt-0.5">Næsta áfylling 10. júní</span>
                        </div>
                      </div>
                      ...
                      <div className="p-4 rounded-2xl bg-blue-50 border border-blue-100/80 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-lg bg-blue-600 flex items-center justify-center text-white">
                            <span className="material-symbols-outlined text-lg font-bold">campaign</span>
                          </div>
                          <div>
                            <span className="text-xs text-slate-500 block font-medium">Í gangi</span>
            ...
            <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200/80 shadow-xl shadow-slate-100/50 relative overflow-hidden">
                ...
                <div className="text-center space-y-4 mb-8">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Reiknaðu ávinninginn þinn</h2>
                  <p className="text-sm text-slate-500 max-w-xl mx-auto">
                    Hér geturðu áætlað birtingafjölda fyrir herferðirnar þínar eða áætlað mánaðarlegar tekjur af vefnum þínum.
                  </p>
                </div>
                    ...
                    {calcMode === 'advertiser' ? (
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          <label className="text-sm font-bold text-slate-700">Mánaðarleg auglýsingafjárhæð</label>
                          <span className="text-base font-extrabold text-blue-600">{advBudget.toLocaleString('is-IS')} kr.</span>
                        </div>
                        <input
                          type="range"
                          min="5000"
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <div className="flex justify-between items-center">
                            <label className="text-sm font-bold text-slate-700">Mánaðarlegar flettingar (Birtingarpláss)</label>
                            <span className="text-base font-extrabold text-blue-600">{pubPageviews.toLocaleString('is-IS')} flettingar</span>
                          </div>
                          <input
                            type="range"
                            min="10000"
                        ...
                        <div className="space-y-4">
                          <div className="flex justify-between items-center">
                            <label className="text-sm font-bold text-slate-700">Nýtingarhlutfall (Fill Rate)</label>
                            <span className="text-base font-extrabold text-blue-600">{pubFillRate}%</span>
                          </div>
                          <input
                            type="range"
                            min="10"
                  ...
                  <div className="md:col-span-5 p-6 rounded-2xl bg-slate-50 border border-slate-200 text-center flex flex-col justify-center min-h-[180px]">
                    {calcMode === 'advertiser' ? (
                      <div className="space-y-3">
                        <span className="text-xs font-bold uppercase text-slate-500 tracking-wider">Áætlaður birtingafjöldi</span>
                        <div className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">
                          {advertiserImpressions.toLocaleString('is-IS')}
                        </div>
                        <span className="text-[10px] text-slate-455 font-semibold block">flettingar á vaxandi íslensku samstarfsneti</span>
                        <div className="pt-2 border-t border-slate-200 text-[10px] text-slate-500 leading-relaxed">
                          Miðað við 350 kr. meðal-CPM. Þú greiðir aðeins fyrir raunverulegar birtingar.
                        </div>
                      </div>
                    ) : (
                      <div className="space-y-3">
                        <span className="text-xs font-bold uppercase text-slate-500 tracking-wider">Áætlaðar mánaðartekjur</span>
                        <div className="text-3xl sm:text-4xl font-black text-green-600 tracking-tight">
                          {publisherRevenue.toLocaleString('is-IS')} kr.
                        </div>
                        <span className="text-[10px] text-slate-455 font-semibold block">greitt út beint á þinn bankareikning</span>
                        <div className="pt-2 border-t border-slate-200 text-[10px] text-slate-500 leading-relaxed">
                          Miðað við 280 kr. nettó-CPM til þín (eftir 20% flatgreidda þóknun kerfis). Greiðslur sendar 1. virka dag.
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <div className="p-8 sm:p-12 rounded-3xl bg-white border border-slate-200/80 shadow-xl shadow-slate-100/50 relative overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto text-center space-y-4 mb-12">
                  ...
                  <p className="text-base text-slate-500">
                    Veldu auglýsingastærð hér fyrir neðan til að sjá hvernig borðarnir aðlagast vefnum og hvernig einfaldi HTML kóðinn uppfærist sjálfkrafa.
                  </p>
                </div>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 min-h-[320px] flex items-center justify-center overflow-x-auto mb-8">
                  ...
                  <div 
                    ...
                    style={{
                      width: sandboxSize === '300x250' ? '300px' : sandboxSize === '728' ? '728px' : '970px',
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 rounded bg-blue-600 flex items-center justify-center font-black text-xs text-white">A</div>
                        <span className="text-xs font-bold text-slate-800">Birta.is</span>
                      </div>
                      <span className="text-[10px] uppercase font-bold tracking-wider text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200">Auglýsing</span>
                    </div>

                    <div className="my-2">
                      <h4 className="font-extrabold text-slate-800 text-sm sm:text-base leading-tight">Einfalt og áhrifaríkt auglýsingaflæði</h4>
                      <p className="text-xs text-slate-500 mt-1 line-clamp-2">Settu upp herferð á nokkrum mínútum og náðu til markhóps þíns á okkar samstarfsvefjum.</p>
                    </div>

                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-semibold text-slate-400">{sandboxSize === '300x250' ? '300x250 px' : sandboxSize === '728' ? '728x90 px' : '970x250 px'}</span>
                      <button className="px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 font-extrabold text-xs text-white transition">Kynna sér málið</button>
                    </div>
                  </div>
                </div>
                ...
                <div className="max-w-2xl mx-auto rounded-xl bg-slate-950 border border-slate-900 overflow-hidden shadow-lg">
                  <div className="px-4 py-2 border-b border-slate-900 flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-400">HTML-kóði fyrir útgefanda</span>
                    <span className="text-[10px] font-mono text-slate-500">Afritaðu á vefsíðuna þína</span>
                  </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
                <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900">Einfaldari vinnubrögð</h2>
                <p className="text-base text-slate-500">Ada (birta.is) er sérsniðin lausn til að leysa algengustu vandamálin við sölu og birtingu vefauglýsinga.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                      Útgefendur geta samþykkt eða hafnað öllu efni áður en það fer í loftið á þeirra vef í gegnum sérstaka samþykkisbiðröð (Approval Queue).
                    </p>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                      Skriftan okkar (widget.js) er undir 5KB að stærð og hleðst í bakgrunni (async). Hún tefur aldrei hleðslu á vefsíðum og hefur engin áhrif á leitarvélabestun (SEO).
                    </p>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 mb-2">Persónuverndarvænt (GDPR)</h3>
                    <p className="text-sm text-slate-500 leading-relaxed">
                      Við notum engar persónugreinanlegar vafrakökur til að fylgjast með notendum. Miðunin byggir á samhengi efnisins (contextual targeting) og landfræði, sem einfaldar lagalegt samræmi.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {currentTab === 'advertisers' && (
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 space-y-20">
            ...
            <div className="space-y-4 text-center">
              <span className="text-xs font-bold uppercase tracking-wider text-blue-600 bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Markaðsmiðlun</span>
              ...
              <p className="text-base sm:text-lg text-slate-500 max-w-2xl mx-auto font-medium">
                Sjálfvirk og einföld stofnun herferða án þess að þurfa dýra milliliði eða flókin auglýsingakerfi.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Samhengismiðuð miðlun (Contextual targeting)</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Settu auglýsingar þínar þar sem lesendur eru þegar að skoða skylt efni. Veldu vefsvæði út frá flokkum (t.d. fjármál, lífsstíll, íþróttir) og landfræðilegu svæði (Höfuðborgarsvæðið / Landsbyggðin) án þess að treysta á skaðlegar vafrakökur.
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Fullt vörumerkjaöryggi (Brand Safety)</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Kerfið framkvæmir sjálfvirka skönnun á öllu skapandi efni (nsfw/ofbeldi) við upphleðslu og fer í gegnum handvirkt samþykkisferli hjá kerfisstjórum. Auglýsingarnar þínar birtast eingöngu á viðurkenndum og gæðamældum samstarfsvefjum.
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Gagnsætt inneignarveski & VSK reikningar</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Þú leggur inn á reikninginn þinn með kreditkorti í gegnum örugga greiðslugátt Teya. Í kjölfar innborgunar færðu samstundis sendan löglegan sölureikning með 24% virðisaukaskatti (VSK) í tölvupósti. Engin fólgin mánaðargjöld.
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Mælingar í rauntíma (Real-time telemetry)</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Fylgstu með birtingum, smellum og smellihlutfalli (CTR) í stjórnborðinu þínu. Kerfið tryggir sjálfvirka reconciliation þannig að herferðir séu paused samstundis þegar áætlaðri inneign er náð, sem kemur í veg fyrir yfirkeyrslu á fjárhagsáætlun.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-slate-200">
              <h2 className="text-2xl font-extrabold text-slate-900 mb-10 text-center">Hvernig fer ferlið fram?</h2>
              
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-6 space-y-8">
                  <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center font-bold text-white shrink-0 shadow-lg shadow-blue-500/20">1</div>
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 mb-1">Stofnaðu aðgang</h3>
                      <p className="text-sm text-slate-500 leading-relaxed">Skráðu fyrirtækið inn með Google eða netfangi. Þú færð samstundis aðgang að auglýsingastjórnborðinu án þess að bíða eftir samþykki.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center font-bold text-white shrink-0 shadow-lg shadow-blue-500/20">2</div>
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 mb-1">Hladdu upp skapandi efni (Creatives)</h3>
                      <p className="text-sm text-slate-500 leading-relaxed">Settu inn myndir, fyrirsagnir og lendingarsíðu (URL) fyrir auglýsinguna þína. Vefurinn þinn sér sjálfkrafa um að stilla stærðir.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center font-bold text-white shrink-0 shadow-lg shadow-blue-500/20">3</div>
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 mb-1">Leggðu inn inneign og virkjaðu</h3>
                      <p className="text-sm text-slate-500 leading-relaxed">Veldu fjárhæð, borgaðu með kreditkorti og herferðin þín fer sjálfkrafa í loftið á samstarfsnetinu okkar.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:col-span-6 p-6 sm:p-8 rounded-3xl bg-white border border-slate-200/80 shadow-md">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed mb-6">
                    Inneignir eru keyptar fyrirfram með kreditkorti í gegnum örugga greiðslugátt **Teya**. Í kjölfar innborgunar er sjálfkrafa stofnaður rafrænn sölureikningur með 24% virðisaukaskatti (VSK) sem sendur er á skráð netfang.
                  </p>
            ...
            <div className="p-8 sm:p-12 rounded-3xl bg-linear-to-r from-blue-50/80 to-indigo-50/80 border border-blue-100/80 text-center space-y-6 shadow-xs">
              ...
              <p className="text-slate-600 text-sm sm:text-base max-w-xl mx-auto font-medium">
                Skráðu fyrirtækið þitt inn í dag, settu upp fyrstu auglýsinguna á nokkrum mínútum og byrjaðu að ná árangri.
              </p>
              <button 
                onClick={() => navigate('/sign-in')}
        ...
        {currentTab === 'publishers' && (
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 space-y-20">
            {/* Header */}
            <div className="space-y-4 text-center">
              <span className="text-xs font-bold uppercase tracking-wider text-blue-600 bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Veftekjur</span>
              <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight">
                Hámarkaðu tekjur vefsins þíns
              </h1>
              <p className="text-base sm:text-lg text-slate-500 max-w-2xl mx-auto font-medium">
                Taktu á móti sjálfvirkum auglýsingum án þess að tapa stjórn á því hvaða efni birtist lesendum þínum.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Gæðamat (Manual approvals queue)</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Engin auglýsing fer í loftið á þínu vefsvæði án þess að þú (eða starfsfólk þitt) samþykki hana í stjórnborðinu þínu. Þú hefur fullt ritstjórnarlegt frelsi til að hafna auglýsingum sem henta ekki þínum lesendum og vernda þannig orðspor vefsins.
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Auðveld og hraðvirk uppsetning</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Þú þarft aðeins að afrita einnar línu HTML-kóða inn á vefsíðuna þína til að virkja kerfið. Skriftan okkar (widget.js) er undir 5KB að stærð, keyrir ósamstillt (async) og hefur engin áhrif á leitarvélabestun (SEO) eða frammistöðu.
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Við gerum upp áunnar auglýsingatekjur mánaðarlega og leggjum þær beint inn á bankareikninginn þinn fyrsta virka dag hvers mánaðar ef lágmarki er náð. Lágmarksútborgun er 5.000 kr. (Nettó).
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Sveigjanlegir verðmöguleikar</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Þú ræður sjálfur verðlagningu fyrir hvert og eitt auglýsingapláss. Styður bæði dynamic CPM-boðkerfi og fast verð fyrir ákveðin tímabil (t.d. fast verð fyrir eina viku eða mánuð).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-slate-200">
              <h2 className="text-2xl font-extrabold text-slate-900 mb-10 text-center">Einfaldleiki í verki</h2>
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-7 space-y-6">
                  <h3 className="text-xl font-bold text-slate-900">Engin flókin kerfi, aðeins ein lína</h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Gleymdu þungum plugins og flóknum samþættingum. Kerfið okkar notar öruggt Javascript og létta HTML tags sem tryggir að vefurinn þinn verður áfram eldsnöggur.
                  </p>
                  <ul className="space-y-3 text-sm text-slate-600">
                    <li className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-blue-600 text-sm font-bold">done</span>
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200/80 shadow-md space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-slate-600 leading-relaxed">
                <p>
                  Kerfið tekur **20% flatgreidda þóknun** (Platform Fee) af öllum auglýsingatekjum sem miðlað er á vefinn þinn. Þessi þóknun stendur straum af rekstri netþjóna, greiðslugáttum, sjálfvirkri nsfw modereringu og umsýslu. Engin önnur gjöld eiga við.
                </p>
                <p>
                  Tekjur þínar safnast upp í rauntíma á fjárhagsbók (ledger) stjórnborðsins. Ef inneign þín nær **5.000 kr.** er hún greidd út á skráðan bankareikning fyrsta virka dag hvers mánaðar. Safnist minni upphæð flyst hún óskert yfir á næsta mánuð.
                </p>
              </div>
            </div>
            ...
            {/* CTA Section */}
            <div className="p-8 sm:p-12 rounded-3xl bg-linear-to-r from-blue-50/80 to-indigo-50/80 border border-blue-100/80 text-center space-y-6 shadow-xs">
              <h3 className="text-2xl font-extrabold text-slate-900">Byrjaðu að safna tekjum í dag</h3>
              <p className="text-slate-600 text-sm sm:text-base max-w-xl mx-auto font-medium">
                Skráðu þig sem útgefanda, búðu til fyrsta auglýsingaplássið þitt og byrjaðu að samþykkja auglýsingar.
              </p>
              <button 
                onClick={() => navigate('/sign-in')}
                className="px-8 py-4 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-base shadow-xl shadow-blue-500/25 transition-all cursor-pointer inline-flex items-center gap-2"
              >
                Bæta við vefsíðu <span className="material-symbols-outlined text-lg">add_to_queue</span>
              </button>
            </div>
          </div>
        )}
        ...
        {currentTab === 'faq' && (
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 space-y-12">
            <div className="space-y-4 text-center">
              ...
              <p className="text-lg text-slate-500">Fljótleg svör við tæknilegum og viðskiptalegum atriðum.</p>
            </div>
        ...
        {currentTab === 'terms' && (
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 space-y-12">
            <div className="space-y-4 text-center">
              ...
              <p className="text-lg text-slate-500 font-medium">Notendaskilmálar og stefna um meðferð persónuupplýsinga hjá Birtu (birta.is).</p>
            </div>
            ...
            <div className="bg-white border border-slate-200/80 rounded-3xl p-8 sm:p-10 shadow-xs space-y-8 text-slate-650 leading-relaxed text-sm">
              <section className="space-y-3">
                <h2 className="text-xl font-bold text-slate-900 border-b border-slate-100 pb-2">1. Almenn ákvæði</h2>
                <p>
                  Vefurinn **birta.is** (hér eftir „Birta“ eða „Vettvangurinn“) er rekinn af **Nútímalegri auglýsingamiðlun ehf.**, kt. 560126-1020, Laugavegi 182, 105 Reykjavík (hér eftir „Félagið“). Birta er sjálfvirkur sjálfsafgreiðsluvettvangur sem tengir saman útgefendur vefsvæða og auglýsendur á Íslandi.
                </p>
                <p>
                  Skilmálar þessir gilda um öll viðskipti og notkun á þjónustu Birtu, hvort sem um ræðir kaup á auglýsingaplássi (auglýsendur) eða sölu á birtingum (útgefendur). Með því að stofna aðgang samþykkja notendur skilmála þessa í heild sinni.
                </p>
              </section>

              <section className="space-y-3">
                <h2 className="text-xl font-bold text-slate-900 border-b border-slate-100 pb-2">2. Skilmálar fyrir auglýsendur (Kaupendur)</h2>
                <p>
                  **Innborgun og Wallet**: Birta notar fyrirframgreitt inneignarkerfi (Wallet). Auglýsendur leggja inn inneign með kreditkorti í gegnum örugga greiðslugátt **Teya**. Lágmarksinnborgun er 2.000 kr. (brúttó, VSK innifalinn). Við hverja innborgun er sjálfkrafa stofnaður rafrænn sölureikningur með 24% virðisaukaskatti (VSK) sem sendur er á skráð netfang. Inneignir fyrnast ekki en eru almennt ekki endurgreiddar nema herferðir séu stöðvaðar af hálfu kerfisins.
                </p>
                <p>
                  **Auglýsingaefni (Creatives)**: Auglýsendur bera fulla ábyrgð á því efni sem þeir hlaða upp í kerfið. Öllum auglýsingum er skannað sjálfvirkt fyrir óviðeigandi efni (t.d. nekt, ofbeldi) og þær þurfa samþykki kerfisstjóra áður en þær fara í birtingu. Ólöglegt efni, hatursáróður eða efni sem brýtur gegn höfundarrétti er stranglega bannað.
                </p>
                <p>
                  **Birtingar og kostnaður**: Kostnaður er dreginn af inneign notanda í rauntíma samkvæmt CPM (kostnaður per 1.000 sýningar) eða samkvæmt föstu verði plássa. Kerfið stöðvar herferð sjálfkrafa um leið og inneign hennar tæmist.
                </p>
              </section>

              <section className="space-y-3">
                <h2 className="text-xl font-bold text-slate-900 border-b border-slate-100 pb-2">3. Skilmálar fyrir útgefendur (Söluaðila)</h2>
                <p>
                  **Uppsetning og rekstur**: Útgefandi setur inn létta Javascript skriftu (widget.js) á sitt vefsvæði til að birta auglýsingar. Skriftan vinnur ósamstillt (async) og fellur út hljóðlaust ef villa kemur upp, án þess að tefja eða skemma fyrir vefnum.
                </p>
                <p>
                  **Ritstjórnarlegt frelsi**: Útgefandi getur virkjað handvirka samþykkisbiðröð (Approvals Queue) í sínu stjórnborði. Þannig er hægt að skoða og samþykkja eða hafna öllum auglýsingaborðum áður en þeir birtast á vefnum.
                </p>
                <p>
                  **Þóknun og greiðslur**: Birta tekur **20% flatgreidda þóknun** af öllum auglýsingatekjum sem miðlast í gegnum kerfið. Þóknunin stendur straum af rekstri, greiðslugáttum og umsýslu. Tekjur útgefanda safnast upp í rauntíma. Ef áunnin inneign nær **5.000 kr.** nettó greiðist hún út á skráðan bankareikning fyrsta virka dag næsta mánaðar. Útgefandi ber ábyrgð á því að banka- og reikningsupplýsingar séu réttar.
                </p>
              </section>

              <section className="space-y-3">
                <h2 className="text-xl font-bold text-slate-900 border-b border-slate-100 pb-2">4. Persónuverndarstefna (GDPR)</h2>
                <p>
                  Birta leggur mikla áherslu á persónuvernd og lágmarkar söfnun gagna. Kerfið safnar **ekki persónugreinanlegum vafrakökum** (tracking cookies) til að fylgjast með notendum á milli vefsvæða.
                </p>
                <p>
                  **Gagnaúrvinnsla**: Auglýsingamiðlun okkar er samhengismiðuð (Contextual Targeting) og byggist á flokkun vefefnis og grófri staðsetningu (landfræðilegt svæði greint út frá IP-tölu á netþjónsstigi). IP-tölur eru aldrei vistaðar í gagnagrunni okkar heldur eru þær eingöngu notaðar í rauntíma til að ákvarða birtingarsvæði og koma í veg fyrir smellasvik (Click Fraud). Birta telst því vera vinnsluaðili (Processor) gagna en útgefandi telst ábyrgðaraðili (Controller) gagnvart sínum lesendum.
                </p>
              </section>

              <section className="space-y-3">
                <h2 className="text-xl font-bold text-slate-900 border-b border-slate-100 pb-2">5. Takmörkun ábyrgðar</h2>
                <p>
                  Birta.is ehf. ábyrgist ekki 100% samfellda keyrslu eða algjört villuleysi í kerfinu. Þjónustan er afhent „eins og hún er“. Félagið ber enga ábyrgð á óbeinu tjóni, glötuðum tekjum útgefenda, eða rekstrartjóni auglýsenda vegna bilana eða tafa á birtingum.
                </p>
              </section>

              <section className="space-y-3">
                <h2 className="text-xl font-bold text-slate-900 border-b border-slate-100 pb-2">6. Gildissvið og varnarþing</h2>
                <p>
                  Skilmálar þessir eru háðir íslenskum lögum. Rísi ágreiningur vegna þeirra eða notkunar á vettvangnum skal málinu vísað til Héraðsdóms Reykjavíkur.
                </p>
                <p className="text-xs text-slate-400 pt-4">
                  Síðast uppfært: 3. júní 2026. Birta.is ehf. áskilur sér rétt til að uppfæra skilmála þessa reglulega.
                </p>
              </section>
            </div>
          </div>
      ...
      <footer className="bg-white border-t border-slate-200/80 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Logo/Info */}
            <div className="space-y-4">
              <div className="flex items-center gap-2 cursor-pointer" onClick={() => changeTab('home')}>
              ...
              <p className="text-xs text-slate-550 leading-relaxed">
                Nútímaleg auglýsingamiðlun ehf.<br />
                Kt. 560126-1020 | VSK nr. 148902<br />
            ...
            {/* Links Advertiser */}
            <div>
              <h4 className="text-xs uppercase font-extrabold tracking-wider text-slate-500 mb-3">Auglýsendur</h4>
              <ul className="space-y-2 text-xs">
                <li><button onClick={() => changeTab('advertisers')} className="text-slate-500 hover:text-slate-850 transition cursor-pointer">Stofna herferð</button></li>
                <li><button onClick={() => changeTab('advertisers')} className="text-slate-500 hover:text-slate-850 transition cursor-pointer">Inneignir og greiðslur</button></li>
              </ul>
            </div>

            {/* Links Publisher */}
            <div>
              <h4 className="text-xs uppercase font-extrabold tracking-wider text-slate-500 mb-3">Útgefendur</h4>
              <ul className="space-y-2 text-xs">
                <li><button onClick={() => changeTab('publishers')} className="text-slate-500 hover:text-slate-850 transition cursor-pointer">Sækja kóða</button></li>
                <li><button onClick={() => changeTab('publishers')} className="text-slate-500 hover:text-slate-850 transition cursor-pointer">Tekjuöflun</button></li>
              </ul>
            </div>

            {/* Legal / Contact */}
            <div>
              <h4 className="text-xs uppercase font-extrabold tracking-wider text-slate-500 mb-3">Þjónusta</h4>
              <ul className="space-y-2 text-xs text-slate-500">
                <li>Hafa samband: <a href="mailto:info@birta.is" className="text-slate-500 hover:text-slate-850 transition">info@birta.is</a></li>
          ...
          <div className="pt-8 border-t border-slate-100 mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <span className="text-[10px] text-slate-500">© 2026 Ada (birta.is) – Nútímaleg auglýsingamiðlun. Allur réttur áskilinn.</span>
            <div className="flex gap-4 text-[10px] text-slate-550">
              <button onClick={() => changeTab('terms')} className="hover:text-slate-800 transition cursor-pointer bg-transparent border-0 p-0 font-normal">Notendaskilmálar</button>
              <button onClick={() => changeTab('terms')} className="hover:text-slate-800 transition cursor-pointer bg-transparent border-0 p-0 font-normal">Persónuverndarstefna</button>
            </div>
          </div>
        </div>
      </footer>
