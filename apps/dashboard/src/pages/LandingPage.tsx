...
export default function LandingPage() {
  ...
  // Dynamic SEO Metadata setup based on active tab
  useEffect(() => {
    let titleText = 'Birtingur — Einfaldar auglýsingar á netinu og birtingar | birtingur.app';
    let descriptionText =
    ...
    if (currentTab === 'faq') {
      titleText = 'Algengar spurningar | Birtingur — Auglýsingar á netinu';
      descriptionText =
      ...
      titleText = 'Skilmálar og persónuvernd | Birtingur — Vefauglýsingar';
      descriptionText =
        ...
        {currentTab === 'faq' && (
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-12 animate-fade-in">
              ...
              <div className="relative max-w-xl mx-auto mt-4">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 font-bold transition text-xs cursor-pointer"
                  >
                    Hreinsa
                  </button>
                )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-slate-655 shrink-0">
              ...
              <button
                ...
                className={`p-5 rounded-2xl border text-left transition-all cursor-pointer flex flex-col justify-between space-y-3 ${
                  selectedPillar === 'technical'
                    ? 'border-blue-600 bg-blue-50/20 text-blue-700 shadow-xs font-bold'
                    : 'border-slate-200 bg-white hover:border-slate-300 text-slate-655 hover:text-slate-900 hover:shadow-xs'
                }`}
              >
