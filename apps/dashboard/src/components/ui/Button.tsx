...
const styles: Record<Variant, string> = {
  primary: 'bg-primary text-white hover:bg-primary-800 active:bg-primary-700 disabled:bg-slate-300 shadow-[0_1px_2px_rgba(0,0,0,0.05)] hover:shadow-md cursor-pointer',
