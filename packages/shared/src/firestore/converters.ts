...
import { WaitlistEntrySchema } from '../schemas/waitlist.js';
...
import type { WaitlistEntry } from '../schemas/waitlist.js';
...
export const waitlistEntryConverter = makeConverter<WaitlistEntry>(WaitlistEntrySchema);
